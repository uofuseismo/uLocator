...
public:
    ...
    [[nodiscard]] virtual std::pair<double, double> geographicToLocalCoordinates(double latitude, double longitude) const = 0;
    ...
    [[nodiscard]] virtual std::unique_ptr<IGeographicRegion> clone() const = 0;
};
}
#endif
