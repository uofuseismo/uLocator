#ifndef ULOCATOR_OPTIMIZERS_NLOPT_BOBYQA_HPP
...
/// @brief Bound Optimization By Quadratic Approximation (BOBYQA) is a local,
///        derivative-free optimizer that can do an excellent job refining
///        an event solution generated by a global search method like
///        DIRECT.  However, the quadratic approximation should not be used
...
public:
    ...
    /// @brief Locates using the BOBYQA method.
    ...
    /// @note This will be 0 because BOBYQA is derivative-free.
    /// @throws std::runtime_error if \c haveOrigin() is false.
