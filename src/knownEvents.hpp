#ifndef ULOCATOR_KNOWN_EVENTS_HPP
#define ULOCATOR_KNOWN_EVENTS_HPP
#include <vector>
namespace
{
std::vector<::KnownUtahEvent> utahKnownEvents()
{
    std::vector<::KnownUtahEvent> events{
          ...
          ::KnownUtahEvent {38.500000, -112.890000, 3200.000000}
    };
    return events;
}

std::vector<::KnownYNPEvent> ynpKnownEvents()
{
